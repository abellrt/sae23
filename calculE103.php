...
foreach ($resultat as $val) {
    if ($val['nom_salle'] == "E103" && $val['type'] == "temperature") {
...
foreach ($resultat as $val) {
    if ($val['nom_salle'] == "E103" && $val['type'] == "humidity") {
...
foreach ($resultat as $val) {
    if ($val['nom_salle'] == "E103" && $val['type'] == "co2") {
...
foreach ($resultat as $val) {
    if ($val['nom_salle'] == "E103" && $val['type'] == "pressure") {
